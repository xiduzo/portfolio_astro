...
This is true for a local setup which enables developers to validate their code locally. However, it is equally important to have a test runner in your CI/CD pipeline.
...
Sure, this makes your life easier in the short term. But over the lifespan of a project you will end up with a lot of unmaintainable tests (read technical debt) you have created yourself unnecessarily.
...
A solution I used before was to make use of the [builder pattern](https://refactoring.guru/design-patterns/builder) to generate the objects for the tests.
