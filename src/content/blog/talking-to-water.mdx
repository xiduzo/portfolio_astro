...
In this post I would like to share the technical aspects of this project.
...
From here on out the students could use the MQTT messages to create the visuals they wanted.

## Experience it yourself
Before going down the rabbit hole and I will lose you. You can experience the project yourself or use it as the basis for your next bodge project!
...
---
---
![Visualization](/blog/talking-to-water/ai-generated-image.png "AI imagination when given the student's description as prompt, krea.ai")

## Magic with 30 lines of code
That is the beauty of the current state of technology. We can bodge together our wildest imaginations with a few lines of code.

By _standing on the shoulder of giants_, we can create magic.
