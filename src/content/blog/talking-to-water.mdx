...
### Works on my machine
While the code presented above worked on my machine, the bodged solution is not without its flaws.
...
But this is a common problem in software development.

The infamous _"works on my machine"_.

![A meme depicting the "works on my machine" issue 600x](/blog/talking-to-water/works-on-my-machine.webp)
