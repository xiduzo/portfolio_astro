...
Mismatching versions and missing dependencies is a common problem in software development.

A common sollution is to make a `Dockerfile` and ship it that way.
