...
pubDate: "Aug 08 2019"
headerColor: "#F2A374"
contrastColor: "#FCD28A"
heroImage: "/project/spirit/header-icon.svg"
---

> _A monster in my mind_ OCD has had a profound impact on my life, muffling my school grades, discontinuing my social life and even forcing me to drop out of university.
> <cite>patient</cite>

---
---
![visualization of monsters which can occupy the patients mind](/project/spirit/monsters.png)
...
---
![onboarding flow spirit application](/project/spirit/intro.png)
...
---
---
![sketches of the paper spirit prototype](/project/spirit/sketch.png)
...
---
![a selection of app screens of the spirit application](/project/spirit/screens.png)

---
---
![visualization about the goal of the spirit application: worry less, live more](/project/spirit/worry_less_live_more.png)
...
![badges representing the gamified experience in the spirit application](/project/spirit/badges.png "Some badge designs")
...
For the basis of the narrative within Spirit, we make use of the [Avoidance hierarchy](https://www.psychologytools.com/resource/avoidance-hierarchy). The avoidance hierarchy is a Cognitive Behavioral Therapy (CBT) worksheet that represents a fear or avoidance hierarchy that helps patients to plan exposure tasks.
...
---
---
![testing the user-flow of the spirit application](/project/spirit/user_flow.png)
...
![all monsters representing the Cognitive Behavioral Therapy (CBT) worksheet levels of the ladder](/project/spirit/monsters_grouped.png "Monsters representing the Cognitive Behavioral Therapy (CBT) worksheet ladder")
...
---
![choosing different moods during an Exposure Response Prevention (ERP) exercise in the spirit application](/project/spirit/fear_levels.png)
...
---
---
![Presenting the spirit application at the Games for Health - Europe conference together with Carmen Scherbaum](/project/spirit/games_for_health.png "Presenting Spirit at the Games for Health conference")

## Invited to
- [Games for health Europe](https://web.archive.org/web/20220526214733/https://www.gamesforhealtheurope.org/speaker/sander-boer)

## In collaboration with
- [Carmen Scherbaum](https://carmenscherbaum.myportfolio.com)
- [Prof. Dr. Steffen Moritz](https://clinical-neuropsychology.de/steffen-moritz)

## References
- [Code](https://github.com/xiduzo/ocdTreatmentApp)