...
## Problem
Having friends at a party with a bad taste in music stinks. This is what [Milan](https://www.linkedin.com/in/milan-van-der-maaten-307a1697) and myself have experienced countless times. Instead of complaining about it constantly we decided to do something about it.
...
## The journey to [expo]("https://docs.expo.dev/")
I was wary of using any cross-platform framework after having some subpar experiences with [Phonegap](https://phonegap.com/), [Ionic](https://ionicframework.com/) and [Flutter](https://flutter.dev/).<br aria-hidden/> However, we never give up, technology moves forward, and there seems to be a _new kid on the block_; [React native](https://reactnative.dev/).

As with all the cross-platform tools I felt more like a _configurator_ than a developer. Constantly fighting the framework to get things done, and having to write platform specific code anyway.<br aria-hidden /><br aria-hidden />

What happened to the fun? Was this the end of the project?

I take great inspiration from [Theo Browne](https://www.youtube.com/@t3dotgg/videos) which is how I stumbled upon the [T3-stack]("https://create.t3.gg/"). No more configuration[^1], just coding
...
## The great reset
No, not [that one](https://www.weforum.org/great-reset/).

Working with TypeScript (for the past 5 years) has been a real game-changer and I would never go without, neither should any sane person. However, TypeScript still has it's quirks.
...
While building Fissa, Spotify introduced the [remote group session](https://support.spotify.com/us/article/remote-group-session/). However, this is always a hidden feature, changes constantly and does not seem to have any focus from Spotify.
...
[I'd like to know more](mailto:mail@sanderboer.nl)


## Experience fissa
- [in the apple app store](https://apps.apple.com/nl/app/fissa-houseparty/id1632218985)
- [in de google play store](https://play.google.com/store/apps/details?id=com.fissa.app)
