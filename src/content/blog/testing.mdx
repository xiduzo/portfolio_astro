...
[codecov](https://about.codecov.io) will give you these insights. You can use it to make educated decisions on the state of your codebase and determine where to focus your testing efforts.

## Conducting simulations

The beaty of testing is that you can simulate (mock) almost everything. This allows you to put your system under stress and force it into states that are hard(er) to reproduce in real life.
