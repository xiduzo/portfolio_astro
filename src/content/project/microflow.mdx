...
After helping students at the [Master Digital Design](https://www.masterdigitaldesign.com/) for some time, I noticed that many students struggled with a common issue: microcontrollers.
...
## Rapid prototyping
While there are some tools available that simplify working with microcontrollers, such as [Johnny Five](http://johnny-five.io/), which allows programming using JavaScript, starting a project still requires writing code.
...
After introducing _variables_ in Microflow, you can create some pretty nifty prototypes and fool any stakeholders, making them believe they're already viewing a real application.
